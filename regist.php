...
<head>
  ...
  <title>Rindu Rental Portal | Registration</title>
  <!--Bootstrap -->
      ...
      <div class="user_profile_info">
        ...
        <div class="col-md-12 col-sm-10">
          <form method="post" name="theform" action="registact.php" id="theform" onSubmit="return checkLetter(this);" enctype="multipart/form-data">
            ...
            <div class="form-group">
              Upload Foto SIM<span style="color:red">*</span><input type="file" name="img2" accept="image/*" required>
            </div>
            <div class="form-group">
          ...
          <div class="modal-footer text-center">
            <p>Sudah punya akun? <a href="#loginform" data-toggle="modal" data-dismiss="modal">Login Di sini.</a></p>
          </div>
