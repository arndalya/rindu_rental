...
if (strlen($_SESSION['ulogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		if ($query) {
			...
			echo "<script type='text/javascript'> document.location = 'booking_detail.php?vid=$vid&mulai=$fromdate&durasi=$durasi&pickup=$pickup&email=$email&biayadriver=$biayadriver&kode=$kode&status=$status&bukti=$bukti&cek=$cek&tgl=$tgl&selesai=$todate'; </script>";
		} else {
...
<!-- /Page Header-->
		<div>
			<br />
			<center>
				<h3>Kendaraan Tersedia untuk Dirental.</h3>
			</center>
			<hr>
		</div>
		<?php
				...
				<div class="user_profile_info">
					<div class="col-md-12 col-sm-10">
						<form method="post" name="sewa" onSubmit="return valid();">
							...
							<div class="form-group">
								<label>Biaya Kendaraan (<?php echo $durasi; ?> Hari)</label><br />
