...
?>
	...
	<head>
		...
		<meta name="keywords" content="">
		<meta name="description" content="">
		<title>Rindu Rental | My Profile</title>
		<!--Bootstrap -->
		<link rel="stylesheet" href="assets/css/bootstrap.min.css" type="text/css">
		<!--Custome Style -->
		<link rel="stylesheet" href="assets/css/style.css" type="text/css">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-heading">Gambar SIM Details</div>
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">

												<div class="form-group">
													<label class="col-sm-4 control-label">Gambar SIM Sekarang</label>
													<div class="col-sm-8">
												...
												<div class="form-group">
													...
													<label class="col-sm-4 control-label">Upload Gambar SIM Baru<span style="color:red">*</span></label>
													<div class="col-sm-8">
