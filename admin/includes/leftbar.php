	<nav class="ts-sidebar">
		<ul class="ts-sidebar-menu">
			<li class="ts-label">Homepage</li>
			<li><a href="dashboard.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
			<li><a href="#"><i class="fa fa-exchange"></i> Rental</a>
				<ul class="ts-sidebar-menu">
					...
					<li><a href="sewa.php">Data Rental</a></li>
				</ul>
			</li>
			<li><a href="#"><i class="fa fa-car"></i> Kendaraan</a>
				<ul class="ts-sidebar-menu">
					<li><a href="merek.php">Data Merek</a></li>
					<li><a href="mobil.php">Data Kendaraan</a></li>
				</ul>
			</li>
			<li><a href="driver.php"><i class="fa fa-money"></i> Biaya Driver</a></li>
			<li><a href="reg-users.php"><i class="fa fa-users"></i> User</a></li>
			<li><a href="manage-conactusquery.php"><i class="fa fa-question"></i> Pesan</a></li>
