...
?>
    ...
    <head>
        ...
        <title>Rindu Rental | Admin Edit Info Motor</title>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">Form Edit Motor</div>
                                        <div class="panel-body">
                                            <?php
                                            $id = intval($_GET['id']);
                                            $sql = "SELECT motor.*,merk.* FROM motor, merk WHERE motor.id_merk=merk.id_merk AND motor.id_motor='$id'";
                                            $query = mysqli_query($koneksidb, $sql);
                                            $result = mysqli_fetch_array($query);
                                            ?>

                                            <form method="post" class="form-horizontal" name="theform" action="motoreditact.php" onsubmit="return valid(this);" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Nama Motor<span style="color:red">*</span></label>
                                                    <div class="col-sm-4">
                                                        <input type="hidden" name="id" class="form-control" value="<?php echo $id; ?>" required>
                                                        <input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result['nama_motor']); ?>" required>
                                                    </div>
                                                    <label class="col-sm-2 control-label">Merk<span style="color:red">*</span></label>
                                                    <div class="col-sm-4">
                                                        <select class="form-control" name="brandname" required="" data-parsley-error-message="Field ini harus diisi">
                                                            <option value=""></option>
                                                            <?php
                                                            $mySql = "SELECT * FROM merk ORDER BY nama_merk";
                                                            $myQry = mysqli_query($koneksidb, $mySql);
                                                            $dataMerk = $result['id_merk'];
                                                            while ($merkData = mysqli_fetch_array($myQry)) {
                                                                if ($merkData['id_merk'] == $dataMerk) {
                                                                    $cek = " selected";
                                                                } else {
                                                                    $cek = "";
                                                                }
                                                                echo "<option value='$merkData[id_merk]' $cek>" . strtoupper($merkData[$nama_merk]) . "</option>";
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Deskripsi Motor<span style="color:red">*</span></label>
                                                    <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <a href="changeimage1.php?imgid=<?php echo htmlentities($result['id_motor']) ?>">Ganti Gambar 1</a>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        Gambar 2<img src="img/vehicleimages/<?php echo htmlentities($result['image2']); ?>" width="300" height="200" style="border:solid 1px #000">
                                                        <a href="changeimage2.php?imgid=<?php echo htmlentities($result['id_motor']) ?>">Ganti Gambar 2</a>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        Gambar 3<img src="img/vehicleimages/<?php echo htmlentities($result['image3']); ?>" width="300" height="200" style="border:solid 1px #000">
                                                        <a href="changeimage3.php?imgid=<?php echo htmlentities($result['id_motor']) ?>">Ganti Gambar 3</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <a href="changeimage4.php?imgid=<?php echo htmlentities($result['id_motor']) ?>">Ganti Gambar 4</a>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        Gambar 5
                                                        <?php if ($result['image5'] == "") {
                                                            ...
                                                            <a href="changeimage5.php?imgid=<?php echo htmlentities($result['id_motor']) ?>">Ganti Gambar 5</a>
                                                        <?php } ?>
                                                    </div>
                                                </div>
