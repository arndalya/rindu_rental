...
?>
    ...
    <head>
        ...
        <title>Rindu Rental | Admin Tambah Motor</title>
        <!-- Font awesome -->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">Form Tambah Motor</div>
                                        <div class="panel-body">
                                            <form method="post" name="theform" action="tambahmotoract.php" class="form-horizontal" onsubmit="return valid(this);" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label">Nama Motor<span style="color:red">*</span></label>
                                                    <div class="col-sm-4">
                                                        <input type="text" name="vehicletitle" class="form-control" required>
                                                    </div>
                                                    <label class="col-sm-2 control-label">Pilih Motor<span style="color:red">*</span></label>
                                                    <div class="col-sm-4">
                                                        <select class="form-control" name="brandname" required="" data-parsley-error-message="Field ini harus diisi">
                                                            ...
                                                            while ($myData = mysqli_fetch_array($myQry)) {
                                                                if ($myData['id_merk'] == $dataMerk) {
                                                                    $cek = " selected";
                                                                } else {
                                                                    $cek = "";
                                                                }
                                                                echo "<option value='$myData[id_merk]' $cek>$myData[nama_merk] </option>";
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
