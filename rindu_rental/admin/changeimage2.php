...
?>
	...
	<head>
		...
		<title>Rindu Rental | Admin Update Image 2</title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Gambar Kendaraan 2</h2>

							<div class="row">
								<div class="col-md-10">
									<div class="panel panel-default">
										<div class="panel-heading">Gambar Kendaraan 2 Details</div>
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">

												<div class="form-group">
													<label class="col-sm-4 control-label">Gambar Kendaraan 2 Sekarang</label>
													<?php
